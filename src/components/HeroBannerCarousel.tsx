...
import { ArrowRight, Rocket, Calendar, GraduationCap, Sparkles } from "lucide-react";
...
const bannerSlides = [
  {
    ...
    description: "New to the Partner Program? Let us guide you through the essentials to start earning.",
  ...
  },
  {
    ...
    description: "Join our live sessions, webinars, and partner meetups to connect and grow.",
    cta: "View Events",
    href: "/learning",
    icon: Calendar,
  ...
  },
  {
    ...
    description: "Hands-on training sessions to master sales techniques and product knowledge.",
  ...
  },
  {
    ...
    description: "Stay informed about the latest features, improvements, and partner tools.",
    cta: "See What's New",
    href: "/learning",
    icon: Sparkles,
